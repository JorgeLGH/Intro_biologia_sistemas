...
We'll work with the bacteria E. coli and with the yeast S. cerevisiae. Fisrtly, the approah will be directly with the sites and then, we'll be using computational ways of accessing the information. 
...
e_coli<-read.table("01_Raw_Data/1aorinter_st.txt")
