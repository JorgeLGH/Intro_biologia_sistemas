...
author: 
- name:  "Antoine Bodein"
  affiliation: "CHU de QuÃ©bec Research Center, UniversitÃ© Laval, Molecular Medicine department, QuÃ©bec, QC, Canada"
...
Each cluster is then further separated into two sets of profiles which we denote as â€œpositiveâ€ or â€œnegativeâ€ based on the sign of the coefficients in the loading vectors 
